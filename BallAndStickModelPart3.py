# -*- coding: utf-8 -*-
"""
Created on Mon Jul 19 14:07:36 2021
...
h.finitialize(-65 * mV) # runs simulation
h.continuerun(100)
...
for i, cell in enumerate(ring.cells):
    plt.vlines(cell.spike_times, i + 0.5, i + 1.5) #raster diagram
plt.show()
...
for syn_w, color in [(0.01, 'black'), (0.005, 'red')]:
    ...
    for i, cell in enumerate(ring.cells):
        plt.vlines(cell.spike_times, i + 0.5, i + 1.5, color=color) # simulation with half the synaptic weight
